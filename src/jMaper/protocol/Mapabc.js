jMaper.Tile.Mapabc = jMaper.Tile.Extend({

	namespace : 'jMaper.Layer.Geog.Tile.Mapabc',
	...
	source : function(l, r, c){
		return this.$.Array.join((function(x, y, z){
			switch(this.style){
				case 't':
				{
					return ['http://tm.mapabc.com/trafficengine/mapabc/traffictile?x=', x, '&y=', y, '&zoom=', 17 - z];
				}
				case 'm':
				{
					return ['http://emap', Math.round(Math.random() * 3), '.mapabc.com/mapabc/maptile?x=', x, '&y=', y, '&z=', z];
				}
				default :
				{
					return [];
		...
		}).call(this, c, r, this.radix + this.start + l), '');
	}
