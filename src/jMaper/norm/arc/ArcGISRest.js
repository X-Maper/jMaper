jMaper.Tile.ArcGISRest = jMaper.Tile.Extend({

	namespace : 'jMaper.Layer.Geog.Tile.ArcGISRest',
	...
	source : function(l, r, c){
		...
		try{
			...
			switch(this.$.Parse.toInt(this.version)){
				case 10 :
				{
					return this.$.Array.join([
						site, '/tile/', this.radix + this.start + l, '/', r, '/', c
					], '');
				}
				case 9 :
				{
